<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="stock_tracking.About" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-6 col-12">
            <div class="input-group mb-3">
                <asp:TextBox ID="txtSearch" CssClass="form-control" placeholder="Search Product" runat="server"></asp:TextBox>
                <div class="input-group-append">
                    <asp:Button ID="btnSearch" CssClass="btn btn-primary" Text="Search" OnClick="btnSearch_Click" runat="server" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="modal fade" id="modalProduct" data-backdrop="false" role="dialog">
            <div class=" modal-dialog modal-dailog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <asp:TextBox ID="txtProductName" CssClass="form-control" placeholder="Name" runat="server" />
